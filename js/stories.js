...
// function that is called when users submit the form from the navbar submit link
async function newStoryForm(evt) {
  console.debug('newStoryForm');
  evt.preventDefault();
  ...
  // implant the newStoryData in the addStory function
  ...
  // slide the form back up and reset it
  $newStoryForm.slideUp('fast');
  $newStoryForm.trigger('reset');

}
$newStoryForm.on('submit', newStoryForm)
